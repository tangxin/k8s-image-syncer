...
+ [kubeimages/metrics-server:v0.3.7](dockerfiles/metrics-server.Dockerfile)
+ [kubeimages/nginx-ingress-controller:v0.25.1](dockerfiles/nginx-ingress-controller.Dockerfile)
+ [kubeimages/pause:3.1](dockerfiles/pause.Dockerfile)
